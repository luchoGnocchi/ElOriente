...
<!--header-->
	<div class="header">
		<!--======= MENU INICIO =======-->
		<?php $entrada_activa = 1;include("f_menu.php"); ?>   
		<!--======= MENU FIN =======-->
    ...
    $(function () {
      $("#slider").responsiveSlides({
		...
		<!--======= SLIDER INICIO =======-->
		<?php include("f_slider.php"); ?>   
		<!--======= SLIDER FIN =======-->
	<!---->
	<!--content-->
	<div class="content">
		<!--======= PROMO INICIO =======-->
		<?php include("f_promo.php"); ?>   
		<!--======= PROMO FIN =======-->
		<div class="content-bottom-grid">
			<div class="container">
				<div class="content-bottom">
					<h3>For all your welding needs</h3>
		...
		<!--======= PRODUCTOS INICIO =======-->
		<?php include("f_productosdestacados.php"); ?>   
		<!--======= PRODUCTOS FIN =======-->
		<!--======= COMUNIQUESE INICIO =======-->
